...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvQuizInfo.setText(Global.info);
    ...
    public void setTvQuizQuestion() {
        ...
        Toast.makeText(getApplicationContext(), "dataCount =" + dataCount + "randomElement =" + randomElement + "currentPosition =" + currentPosition, Toast.LENGTH_LONG).show();
